function initMap() {
    ...
    var contentString = '<div id="content">'+
            ...
            '<h5>Total Bookings:</h5>'+'<h5 style="color:green;">2500</h5>'+
        '<h5>Available Booking</h5>'+'<h5 style="color:green;">250</h5>'
            '</div>'+
            '</div>';
    ...
    var contentString1 = '<div id="content">'+
            ...
            '<h5>Total Bookings:</h5>'+'<h5 style="color:green;">2500</h5>'+
        '<h5>Available Booking</h5>'+'<h5 style="color:red;">0</h5>'
            '</div>'+
            '</div>';
    ...
    var contentString2 = '<div id="content">'+
            ...
            '<h5>Status: </h5>'+'<h5 style="color:green;">Available</h5>'+
            '<h5>Total Bookings:</h5>'+'<h5 style="color:green;">2500</h5>'+
        '<h5>Available Booking</h5>'+'<h5 style="color:yellow;">15</h5>'
            '</div>'+
            '</div>';
    ...
    var contentString3 = '<div id="content">'+
            ...
            '<div id="bodyContent">'+
            '<h5>Status: </h5>'+'<h5 style="color:green;">Available</h5>'+
            '<h5>Total Bookings:</h5>'+'<h5 style="color:green;">800</h5>'+
        '<h5>Available Booking</h5>'+'<h5 style="color:yellow;">15</h5>'
            '</div>'+
            '</div>';
    ...
    var contentString4 = '<div id="content">'+
            ...
            '<div id="bodyContent">'+
            '<h5>Status: </h5>'+'<h5 style="color:green;">Available</h5>'+
            '<h5>Total Bookings:</h5>'+'<h5 style="color:green;">600</h5>'+
        '<h5>Available Booking</h5>'+'<h5 style="color:yellow;">305</h5>'
            '</div>'+
            '</div>';
    ...
    var contentString7 = '<div id="content">'+
            ...
            '<h5>Status: </h5>'+'<h5 style="color:green;">Available</h5>'+
            '<h5>Total Bookings:</h5>'+'<h5 style="color:green;">600</h5>'+
        '<h5>Available Booking</h5>'+'<h5 style="color:green;">150</h5>'+
            '</div>'+
            '</div>';
        ...
        marker7.addListener('dblclick', function() {
          $("#staticLocation").val(marker7['title']);
        });
